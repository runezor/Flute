...
module mkDM_Abstract_Commands(CLK,
  ...
  wire [63 : 0] req_data__h854;
  wire [31 : 0] virt_rg_abstractcs__h714, virt_rg_command__h764;
  wire [15 : 0] regno__h2635;
  wire [12 : 0] x__h1315, x__h1740;
  ...
  always@(av_read_dm_addr or
	  rg_data1 or
	  rg_data0 or virt_rg_abstractcs__h714 or virt_rg_command__h764)
  begin
    case (av_read_dm_addr)
      7'h04: av_read = rg_data0;
      7'h16: av_read = virt_rg_abstractcs__h714;
      7'h17: av_read = virt_rg_command__h764;
  ...
  // remaining internal signals
  assign regno__h2635 = { 3'd0, rg_command_access_reg_regno } ;
  assign req_data__h854 = { rg_data1, rg_data0 } ;
  ...
  assign virt_rg_abstractcs__h714 =
	     { 19'd0, rg_abstractcs_busy, 1'b0, rg_abstractcs_cmderr, 8'd2 } ;
  assign virt_rg_command__h764 =
	     { 15'd17, rg_command_access_reg_write, regno__h2635 } ;
  ...
  assign x__h1315 = rg_command_access_reg_regno - 13'h1000 ;
  assign x__h1740 = rg_command_access_reg_regno - 13'h1020 ;
  ...
  begin
    ...
    if (RST_N != `BSV_RESET_VALUE)
	  ...
	  write_dm_addr != 7'h04 &&
	  write_dm_addr != 7'h05)
	$write("%0d: DM_Abstract_Commands.write: [", v__h4104);
    if (RST_N != `BSV_RESET_VALUE)
