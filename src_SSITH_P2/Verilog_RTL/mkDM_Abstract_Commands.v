...
module mkDM_Abstract_Commands(CLK,
  ...
  wire [63 : 0] req_data__h844;
  wire [31 : 0] virt_rg_abstractcs__h708, virt_rg_command__h754;
  wire [15 : 0] regno__h2625;
  wire [12 : 0] x__h1305, x__h1730;
  wire rg_abstractcs_busy_read_AND_rg_start_reg_acces_ETC___d38,
       ...
       rg_abstractcs_cmderr_read__1_EQ_0_07_AND_write_ETC___d142,
       rg_abstractcs_cmderr_read__1_EQ_0_07_AND_write_ETC___d174,
  ...
  always@(av_read_dm_addr or
	  rg_data1 or
	  rg_data0 or virt_rg_abstractcs__h708 or virt_rg_command__h754)
  begin
    case (av_read_dm_addr)
      7'h04: av_read = rg_data0;
      7'h16: av_read = virt_rg_abstractcs__h708;
      7'h17: av_read = virt_rg_command__h754;
  ...
  assign MUX_f_hart0_csr_reqs$enq_1__VAL_1 =
	     { 1'd1, rg_command_access_reg_regno[11:0], req_data__h844 } ;
  ...
  // remaining internal signals
  assign regno__h2625 = { 3'd0, rg_command_access_reg_regno } ;
  assign req_data__h844 = { rg_data1, rg_data0 } ;
  ...
  assign rg_abstractcs_busy_read_AND_rg_start_reg_acces_ETC___d72 =
	     ...
	     !rg_command_access_reg_regno_read_ULT_0x1020___d57 &&
	     rg_command_access_reg_regno_read_ULE_0x103F___d59 ;
  assign rg_abstractcs_cmderr_read__1_EQ_0_07_AND_write_ETC___d142 =
	     rg_abstractcs_cmderr == 3'd0 && write_dm_addr == 7'h17 &&
	     !rg_abstractcs_busy &&
	     write_dm_word[24] ;
  assign rg_abstractcs_cmderr_read__1_EQ_0_07_AND_write_ETC___d174 =
	     rg_abstractcs_cmderr == 3'd0 && write_dm_addr == 7'h17 &&
	     !rg_abstractcs_busy &&
	     !write_dm_word[24] &&
  ...
  assign virt_rg_abstractcs__h708 =
	     { 19'd0, rg_abstractcs_busy, 1'b0, rg_abstractcs_cmderr, 8'd2 } ;
  assign virt_rg_command__h754 =
	     { 15'd17, rg_command_access_reg_write, regno__h2625 } ;
  ...
  assign x__h1305 = rg_command_access_reg_regno - 13'h1000 ;
  assign x__h1730 = rg_command_access_reg_regno - 13'h1020 ;
  ...
  begin
    ...
    if (RST_N != `BSV_RESET_VALUE)
	  ...
	  write_dm_addr != 7'h04 &&
	  write_dm_addr != 7'h05)
	$write("%0d: DM_Abstract_Commands.write: [", v__h4094);
    if (RST_N != `BSV_RESET_VALUE)
