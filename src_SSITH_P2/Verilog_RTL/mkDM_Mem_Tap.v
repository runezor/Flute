...
module mkDM_Mem_Tap(CLK,
  ...
  reg [2 : 0] sz__h1701;
  wire [63 : 0] x__h1769, x__h1852, x__h1866;
  ...
  assign slavePortShim_wff_i_notEmpty_AND_masterPortShi_ETC___d10 =
	     ...
	     masterPortShim_wff$FULL_N &&
	     f_trace_data$FULL_N ;
  assign x__h1769 = { 61'd0, sz__h1701 } ;
  assign x__h1852 = x__h1866 & y__h1867 ;
  assign x__h1866 =
  ...
  begin
    case (slavePortShim_wff$D_OUT[9:2])
      8'h03, 8'h0C, 8'h30, 8'hC0: sz__h1701 = 3'b001;
      8'h0F, 8'hF0: sz__h1701 = 3'b010;
      8'h10, 8'h20, 8'h40, 8'h80: sz__h1701 = 3'b0;
      8'hFF: sz__h1701 = 3'b011;
      default: sz__h1701 = 3'b0;
    endcase
  end
  always@(slavePortShim_wff$D_OUT)
  begin
  ...
  begin
    case (slavePortShim_wff$D_OUT[9:2])
	  ...
	  y__h1867 = 64'h00000000000000FF;
      8'h03, 8'h0C, 8'h30, 8'hC0: y__h1867 = 64'h000000000000FFFF;
      8'h0F, 8'hF0: y__h1867 = 64'h00000000FFFFFFFF;
      8'hFF: y__h1867 = 64'hFFFFFFFFFFFFFFFF;
      default: y__h1867 = 64'd0;
    endcase
  end
