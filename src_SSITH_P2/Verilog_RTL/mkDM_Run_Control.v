...
module mkDM_Run_Control(CLK,
  ...
  wire [31 : 0] haltsum__h692,
		virt_rg_dmcontrol__h886,
		virt_rg_dmstatus__h784;
  ...
  always@(av_read_dm_addr or
	  rg_verbosity or
	  virt_rg_dmcontrol__h886 or virt_rg_dmstatus__h784 or haltsum__h692)
  begin
    case (av_read_dm_addr)
      7'h10: av_read = virt_rg_dmcontrol__h886;
      7'h11: av_read = virt_rg_dmstatus__h784;
      7'h13, 7'h40: av_read = haltsum__h692;
  ...
  assign NOT_rg_dmstatus_allunavail_9_5_AND_rg_dmcontro_ETC___d90 =
	     ...
	     write_dm_word[31] &&
	     write_dm_word[30] ;
  assign haltsum__h692 = { 31'h0, !rg_hart0_running } ;
  assign virt_rg_dmcontrol__h886 =
	     { 2'b0,
	       rg_dmcontrol_hartreset,
	       27'd0,
	       rg_dmcontrol_ndmreset,
	       rg_dmcontrol_dmactive } ;
  assign virt_rg_dmstatus__h784 =
	     { 12'd0,
	       rg_hart0_hasreset,
	       rg_hart0_hasreset,
  ...
  begin
    ...
    if (RST_N != `BSV_RESET_VALUE)
      if (EN_write && write_dm_addr == 7'h10 && write_dm_word[0] &&
	  NOT_rg_dmstatus_allunavail_9_5_AND_rg_dmcontro_ETC___d111)
	$display("%0d: %m.dmcontrol_write: hart0 resume request", v__h3010);
    if (RST_N != `BSV_RESET_VALUE)
      if (EN_write && write_dm_addr == 7'h10 && write_dm_word[0] &&
	  NOT_rg_dmstatus_allunavail_9_5_AND_rg_dmcontro_ETC___d120)
	begin
    ...
    if (RST_N != `BSV_RESET_VALUE)
      if (EN_write && write_dm_addr == 7'h10 && write_dm_word[0] &&
	  NOT_rg_dmstatus_allunavail_9_5_AND_rg_dmcontro_ETC___d120)
	$display("%0d: %m.dmcontrol_write: hart0 halt request", v__h3050);
    if (RST_N != `BSV_RESET_VALUE)
      if (EN_write && write_dm_addr == 7'h10 && !write_dm_word[0])
	begin
	  v__h2093 = $stime;
