...
module mkGPR_RegFile(CLK,
  ...
  wire [65 : 0] thin_address__h1193, thin_address__h728, thin_address__h962;
  ...
  wire [17 : 0] thin_otype__h1198, thin_otype__h733, thin_otype__h967;
  wire [13 : 0] thin_addrBits__h1194,
		thin_addrBits__h729,
		thin_addrBits__h963,
		x__h1125,
		x__h1128,
  ...
  wire [3 : 0] thin_perms_soft__h1213,
	       thin_perms_soft__h748,
	       thin_perms_soft__h982;
  wire [2 : 0] repBound__h1118, repBound__h1349, repBound__h884;
  wire [1 : 0] thin_reserved__h1197, thin_reserved__h732, thin_reserved__h966;
  ...
  assign read_rs2 =
	     { read_rs2_rs2 != 5'd0 && regfile$D_OUT_1[152],
	       thin_address__h1193,
	       thin_addrBits__h1194,
	       thin_perms_soft__h1213,
  ...
  assign IF_read_rs1_port2_rs1_EQ_0_6_THEN_0_ELSE_regfi_ETC___d149 =
	     x__h1125[13:11] < repBound__h1118 ;
  assign IF_read_rs1_port2_rs1_EQ_0_6_THEN_0_ELSE_regfi_ETC___d151 =
	     thin_addrBits__h963[13:11] < repBound__h1118 ;
  ...
  assign IF_read_rs1_port2_rs1_EQ_0_6_THEN_4096_ELSE_re_ETC___d148 =
	     x__h1128[13:11] < repBound__h1118 ;
  ...
  assign IF_read_rs1_rs1_EQ_0_THEN_0_ELSE_regfile_sub_r_ETC___d72 =
	     x__h891[13:11] < repBound__h884 ;
  assign IF_read_rs1_rs1_EQ_0_THEN_0_ELSE_regfile_sub_r_ETC___d74 =
	     thin_addrBits__h729[13:11] < repBound__h884 ;
  ...
  assign IF_read_rs2_rs2_EQ_0_63_THEN_0_ELSE_regfile_su_ETC___d226 =
	     x__h1356[13:11] < repBound__h1349 ;
  assign IF_read_rs2_rs2_EQ_0_63_THEN_0_ELSE_regfile_su_ETC___d228 =
	     thin_addrBits__h1194[13:11] < repBound__h1349 ;
  ...
  assign IF_read_rs2_rs2_EQ_0_63_THEN_4096_ELSE_regfile_ETC___d225 =
	     x__h1359[13:11] < repBound__h1349 ;
  assign repBound__h1118 = x__h1125[13:11] - 3'b001 ;
  assign repBound__h1349 = x__h1356[13:11] - 3'b001 ;
  assign repBound__h884 = x__h891[13:11] - 3'b001 ;
  assign thin_addrBits__h1194 =
	     (read_rs2_rs2 == 5'd0) ? 14'd0 : regfile$D_OUT_1[85:72] ;
  assign thin_addrBits__h729 =
	     (read_rs1_rs1 == 5'd0) ? 14'd0 : regfile$D_OUT_3[85:72] ;
  assign thin_addrBits__h963 =
	     (read_rs1_port2_rs1 == 5'd0) ? 14'd0 : regfile$D_OUT_2[85:72] ;
  assign thin_address__h1193 =
	     (read_rs2_rs2 == 5'd0) ? 66'd0 : regfile$D_OUT_1[151:86] ;
  assign thin_address__h728 =
	     (read_rs1_rs1 == 5'd0) ? 66'd0 : regfile$D_OUT_3[151:86] ;
  assign thin_address__h962 =
	     (read_rs1_port2_rs1 == 5'd0) ? 66'd0 : regfile$D_OUT_2[151:86] ;
  assign thin_flags__h1196 = read_rs2_rs2 != 5'd0 && regfile$D_OUT_1[55] ;
  assign thin_flags__h731 = read_rs1_rs1 != 5'd0 && regfile$D_OUT_3[55] ;
  assign thin_flags__h965 =
	     read_rs1_port2_rs1 != 5'd0 && regfile$D_OUT_2[55] ;
  assign thin_otype__h1198 =
	     (read_rs2_rs2 == 5'd0) ? 18'd262143 : regfile$D_OUT_1[52:35] ;
  assign thin_otype__h733 =
	     (read_rs1_rs1 == 5'd0) ? 18'd262143 : regfile$D_OUT_3[52:35] ;
  assign thin_otype__h967 =
	     (read_rs1_port2_rs1 == 5'd0) ?
	       18'd262143 :
	       regfile$D_OUT_2[52:35] ;
  assign thin_perms_soft__h1213 =
	     (read_rs2_rs2 == 5'd0) ? 4'd0 : regfile$D_OUT_1[71:68] ;
  assign thin_perms_soft__h748 =
	     (read_rs1_rs1 == 5'd0) ? 4'd0 : regfile$D_OUT_3[71:68] ;
  assign thin_perms_soft__h982 =
	     (read_rs1_port2_rs1 == 5'd0) ? 4'd0 : regfile$D_OUT_2[71:68] ;
  assign thin_reserved__h1197 =
	     (read_rs2_rs2 == 5'd0) ? 2'd0 : regfile$D_OUT_1[54:53] ;
  assign thin_reserved__h732 =
	     (read_rs1_rs1 == 5'd0) ? 2'd0 : regfile$D_OUT_3[54:53] ;
  assign thin_reserved__h966 =
  ...
  assign x__h1356 = (read_rs2_rs2 == 5'd0) ? 14'd0 : regfile$D_OUT_1[13:0] ;
  assign x__h1359 =
	     (read_rs2_rs2 == 5'd0) ? 14'd4096 : regfile$D_OUT_1[27:14] ;
  assign x__h891 = (read_rs1_rs1 == 5'd0) ? 14'd0 : regfile$D_OUT_3[13:0] ;
  assign x__h894 =
