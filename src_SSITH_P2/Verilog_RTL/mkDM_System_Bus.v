...
module mkDM_System_Bus(CLK,
  ...
  reg [63 : 0] CASE_rg_sbaddress_reading_BITS_2_TO_0_0x0_resu_ETC__q1,
	       ...
	       wrd_wdata__h4494;
  reg [7 : 0] wrd_wstrb__h4495;
  reg [2 : 0] _theResult___snd_snd_val__h4446, axi4_size_val__h2772;
  wire [63 : 0] _theResult___fst__h4431,
		addr64__h3786,
		result__h1213,
		result__h1243,
		result__h1270,
  ...
  wire [31 : 0] IF_rg_sbcs_sbreadonaddr_35_THEN_IF_rg_sbcs_sba_ETC___d321,
		...
		v__h2216,
		v__h2350;
  wire [7 : 0] strobe64__h4429, strobe64__h4433, strobe64__h4437;
  wire [5 : 0] shift_bits__h4379;
  ...
  always@(av_read_dm_addr or
	  v__h2216 or rg_sbaddress0 or rg_sbaddress1 or v__h2350)
  begin
    case (av_read_dm_addr)
      7'h38: av_read = v__h2216;
      7'h39: av_read = rg_sbaddress0;
      7'h3A: av_read = rg_sbaddress1;
      7'h3C: av_read = v__h2350;
  ...
  assign MUX_masterPortShim_arff$enq_1__VAL_1 =
	     { 4'd0,
	       sbaddress__h617,
	       8'd0,
	       axi4_size_val__h2772,
	       18'd65536 } ;
  assign MUX_masterPortShim_arff$enq_1__VAL_2 =
	     { 4'd0, addr64__h3786, 8'd0, axi4_size_val__h2772, 18'd65536 } ;
  ...
  assign masterPortShim_awff$D_IN =
	     { 4'd0,
	       sbaddress__h617,
	       8'd0,
	       _theResult___snd_snd_val__h4446,
	       18'd65536 } ;
  ...
  assign masterPortShim_wff$D_IN =
	     { wrd_wdata__h4494, wrd_wstrb__h4495, 2'd2 } ;
  ...
  assign IF_write_dm_addr_EQ_0x39_69_THEN_rg_sbaddress1_ETC___d312 =
	     (write_dm_addr == 7'h39) ?
	       ...
	       write_dm_word ;
  assign _theResult___fst__h4431 = word64__h4376 << shift_bits__h4379 ;
  assign addr64__h3786 = { rg_sbaddress1, write_dm_word } ;
  assign result__h1213 = { 56'd0, masterPortShim_rff$D_OUT[11:4] } ;
  assign result__h1243 = { 56'd0, masterPortShim_rff$D_OUT[19:12] } ;
  assign result__h1270 = { 56'd0, masterPortShim_rff$D_OUT[27:20] } ;
  assign result__h1297 = { 56'd0, masterPortShim_rff$D_OUT[35:28] } ;
  assign result__h1324 = { 56'd0, masterPortShim_rff$D_OUT[43:36] } ;
  assign result__h1351 = { 56'd0, masterPortShim_rff$D_OUT[51:44] } ;
  assign result__h1378 = { 56'd0, masterPortShim_rff$D_OUT[59:52] } ;
  assign result__h1405 = { 56'd0, masterPortShim_rff$D_OUT[67:60] } ;
  assign result__h1450 = { 48'd0, masterPortShim_rff$D_OUT[19:4] } ;
  assign result__h1477 = { 48'd0, masterPortShim_rff$D_OUT[35:20] } ;
  assign result__h1504 = { 48'd0, masterPortShim_rff$D_OUT[51:36] } ;
  assign result__h1531 = { 48'd0, masterPortShim_rff$D_OUT[67:52] } ;
  assign result__h1572 = { 32'd0, masterPortShim_rff$D_OUT[35:4] } ;
  assign result__h1599 = { 32'd0, masterPortShim_rff$D_OUT[67:36] } ;
  ...
  assign rg_sbcs_sberror_EQ_0_AND_rg_sbcs_sbreadonaddr__ETC___d302 =
	     ...
	     (rg_sbcs_sbreadonaddr && rg_sbcs_sbautoincrement ||
	      write_dm_addr != 7'h39) ;
  assign sbaddress__h617 = { rg_sbaddress1, rg_sbaddress0 } ;
  assign shift_bits__h4379 = { rg_sbaddress0[2:0], 3'b0 } ;
  assign strobe64__h4429 = 8'b00000001 << rg_sbaddress0[2:0] ;
  assign strobe64__h4433 = 8'b00000011 << rg_sbaddress0[2:0] ;
  assign strobe64__h4437 = 8'b00001111 << rg_sbaddress0[2:0] ;
  assign v__h2216 =
	     { 9'd64,
	       rg_sbcs_sbbusyerror,
	       rg_sb_state != 2'd0,
  ...
  assign v__h2350 =
	     (rg_sb_state != 2'd0 || rg_sbcs_sbbusyerror ||
	      rg_sbcs_sberror != 3'd0) ?
	       32'd0 :
	       rg_sbdata0 ;
  assign word64__h4376 = { 32'd0, write_dm_word } ;
  ...
  begin
    case (rg_sbcs_sbaccess)
      3'd0, 3'd1, 3'd2: axi4_size_val__h2772 = rg_sbcs_sbaccess;
      default: axi4_size_val__h2772 = 3'b011;
    endcase
  end
  always@(rg_sbcs_sbaccess)
  begin
    case (rg_sbcs_sbaccess)
      3'd0, 3'd1, 3'd2, 3'd3:
	  _theResult___snd_snd_val__h4446 = rg_sbcs_sbaccess;
      default: _theResult___snd_snd_val__h4446 = 3'b111;
    endcase
  end
  always@(rg_sbcs_sbaccess or
	  strobe64__h4429 or strobe64__h4433 or strobe64__h4437)
  begin
    case (rg_sbcs_sbaccess)
      3'd0: wrd_wstrb__h4495 = strobe64__h4429;
      3'd1: wrd_wstrb__h4495 = strobe64__h4433;
      3'd2: wrd_wstrb__h4495 = strobe64__h4437;
      3'd3: wrd_wstrb__h4495 = 8'b11111111;
      default: wrd_wstrb__h4495 = 8'd0;
    endcase
  end
  always@(rg_sbcs_sbaccess or word64__h4376 or _theResult___fst__h4431)
  begin
    case (rg_sbcs_sbaccess)
      3'd0, 3'd1, 3'd2: wrd_wdata__h4494 = _theResult___fst__h4431;
      default: wrd_wdata__h4494 = word64__h4376;
    endcase
  end
  always@(rg_sbcs_sbaccess)
  begin
  ...
  always@(rg_sbaddress_reading or
	  ...
	  result__h1270 or
	  result__h1297 or
	  result__h1324 or result__h1351 or result__h1378 or result__h1405)
  begin
  ...
  always@(rg_sbaddress_reading or
	  result__h1450 or result__h1477 or result__h1504 or result__h1531)
  begin
    case (rg_sbaddress_reading[2:0])
      3'h0:
	  IF_rg_sbaddress_reading_9_BITS_2_TO_0_0_EQ_0x0_ETC___d75 =
  ...
  always@(rg_sbaddress_reading or result__h1572 or result__h1599)
  begin
    case (rg_sbaddress_reading[2:0])
      3'h0:
