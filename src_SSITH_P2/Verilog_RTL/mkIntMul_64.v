...
module mkIntMul_64(CLK,
  ...
  wire [127 : 0] x__h236, x__h329, xy___1__h253;
  wire [63 : 0] _theResult___fst__h490,
		_theResult___fst__h493,
		_theResult___fst__h535,
		_theResult___fst__h538,
		_theResult___snd_fst__h530;
  ...
  // inputs to muxes for submodule ports
  assign MUX_m_rg_x$write_1__VAL_1 = { 64'd0, _theResult___fst__h490 } ;
  assign MUX_m_rg_x$write_1__VAL_2 = { m_rg_x[126:0], 1'd0 } ;
  assign MUX_m_rg_xy$write_1__VAL_2 = (m_rg_y == 64'd0) ? x__h236 : x__h329 ;
  ...
  assign _theResult___fst__h490 =
	     put_args_x_is_signed ? _theResult___fst__h493 : put_args_x ;
  assign _theResult___fst__h493 = put_args_x[63] ? -put_args_x : put_args_x ;
  assign _theResult___fst__h535 =
	     put_args_y_is_signed ? _theResult___fst__h538 : put_args_y ;
  assign _theResult___fst__h538 = put_args_y[63] ? -put_args_y : put_args_y ;
  assign _theResult___snd_fst__h530 =
	     put_args_x_is_signed ? put_args_y : _theResult___fst__h535 ;
  assign x__h236 = m_rg_isNeg ? xy___1__h253 : m_rg_xy ;
  assign x__h329 = m_rg_xy + m_rg_x ;
  assign xy___1__h253 = -m_rg_xy ;
