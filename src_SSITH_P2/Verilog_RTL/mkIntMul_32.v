...
module mkIntMul_32(CLK,
  ...
  wire [63 : 0] x__h271, x__h364, xy___1__h288;
  wire [31 : 0] _theResult___fst__h525,
  ...
  // inputs to muxes for submodule ports
  assign MUX_m_rg_x$write_1__VAL_1 = { 32'd0, _theResult___fst__h525 } ;
  assign MUX_m_rg_x$write_1__VAL_2 = { m_rg_x[62:0], 1'd0 } ;
  assign MUX_m_rg_xy$write_1__VAL_2 = (m_rg_y == 32'd0) ? x__h271 : x__h364 ;
  ...
  assign _theResult___fst__h528 = put_args_x[31] ? -put_args_x : put_args_x ;
  assign _theResult___fst__h570 =
	     put_args_y_is_signed ? _theResult___fst__h573 : put_args_y ;
  assign _theResult___fst__h573 = put_args_y[31] ? -put_args_y : put_args_y ;
