...
module mkCSR_MIP(CLK,
  ...
  // value method mv_read
  assign mv_read = { 52'd0, new_mip__h526 } ;

  // actionvalue method mav_write
  assign mav_write = { 52'd0, new_mip__h944 } ;
  ...
  // register rg_ssip
  always@(EN_reset or
	  EN_mav_write or ssip__h564 or EN_mav_sip_write or ssip__h984)
  case (1'b1)
    EN_reset: rg_ssip$D_IN = 1'd0;
    EN_mav_write: rg_ssip$D_IN = ssip__h564;
    EN_mav_sip_write: rg_ssip$D_IN = ssip__h984;
  ...
  // register rg_ueip
  always@(EN_reset or
	  EN_mav_write or ueip__h561 or EN_mav_sip_write or ueip__h983)
  case (1'b1)
    EN_reset: rg_ueip$D_IN = 1'd0;
    EN_mav_write: rg_ueip$D_IN = ueip__h561;
    EN_mav_sip_write: rg_ueip$D_IN = ueip__h983;
  ...
  // register rg_usip
  always@(EN_reset or
	  EN_mav_write or usip__h565 or EN_mav_sip_write or usip__h985)
  case (1'b1)
    EN_reset: rg_usip$D_IN = 1'd0;
    EN_mav_write: rg_usip$D_IN = usip__h565;
    EN_mav_sip_write: rg_usip$D_IN = usip__h985;
  ...
  assign new_mip__h944 =
	     { rg_meip,
	       ...
	       ssip__h564,
	       usip__h565 } ;
  assign seip__h560 = mav_write_misa[18] && mav_write_wordxl[9] ;
  assign ssip__h564 = mav_write_misa[18] && mav_write_wordxl[1] ;
  assign ssip__h984 = mav_sip_write_misa[18] && mav_sip_write_wordxl[1] ;
  assign stip__h562 = mav_write_misa[18] && mav_write_wordxl[5] ;
  assign ueip__h561 = mav_write_misa[13] && mav_write_wordxl[8] ;
  assign ueip__h983 = mav_sip_write_misa[13] && mav_sip_write_wordxl[8] ;
  assign usip__h565 = mav_write_misa[13] && mav_write_wordxl[0] ;
  assign usip__h985 = mav_sip_write_misa[13] && mav_sip_write_wordxl[0] ;
  assign utip__h563 = mav_write_misa[13] && mav_write_wordxl[4] ;
