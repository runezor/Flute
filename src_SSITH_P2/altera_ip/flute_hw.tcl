...
add_fileset_file mkBoot_ROM.v VERILOG PATH ../Verilog_RTL/mkBoot_ROM.v
add_fileset_file mkBranch_Predictor.v VERILOG PATH ../Verilog_RTL/mkBranch_Predictor.v
add_fileset_file mkCPU.v VERILOG PATH ../Verilog_RTL/mkCPU.v
add_fileset_file mkCSR_MIE.v VERILOG PATH ../Verilog_RTL/mkCSR_MIE.v
add_fileset_file mkCSR_MIP.v VERILOG PATH ../Verilog_RTL/mkCSR_MIP.v
add_fileset_file mkCSR_RegFile.v VERILOG PATH ../Verilog_RTL/mkCSR_RegFile.v
add_fileset_file mkCore.v VERILOG PATH ../Verilog_RTL/mkCore.v
add_fileset_file mkCore_Synth.v VERILOG PATH ../Verilog_RTL/mkCore_Synth.v
add_fileset_file mkDM_Abstract_Commands.v VERILOG PATH ../Verilog_RTL/mkDM_Abstract_Commands.v
add_fileset_file mkDM_CSR_Tap.v VERILOG PATH ../Verilog_RTL/mkDM_CSR_Tap.v
add_fileset_file mkDM_FPR_Tap.v VERILOG PATH ../Verilog_RTL/mkDM_FPR_Tap.v
add_fileset_file mkDM_GPR_Tap.v VERILOG PATH ../Verilog_RTL/mkDM_GPR_Tap.v
add_fileset_file mkDM_Mem_Tap.v VERILOG PATH ../Verilog_RTL/mkDM_Mem_Tap.v
add_fileset_file mkDM_Run_Control.v VERILOG PATH ../Verilog_RTL/mkDM_Run_Control.v
add_fileset_file mkDM_System_Bus.v VERILOG PATH ../Verilog_RTL/mkDM_System_Bus.v
add_fileset_file mkDebug_Module.v VERILOG PATH ../Verilog_RTL/mkDebug_Module.v
add_fileset_file mkFBox_Core.v VERILOG PATH ../Verilog_RTL/mkFBox_Core.v
add_fileset_file mkFBox_Top.v VERILOG PATH ../Verilog_RTL/mkFBox_Top.v
add_fileset_file mkFPR_RegFile.v VERILOG PATH ../Verilog_RTL/mkFPR_RegFile.v
add_fileset_file mkFPU.v VERILOG PATH ../Verilog_RTL/mkFPU.v
add_fileset_file mkFabric_2x3.v VERILOG PATH ../Verilog_RTL/mkFabric_2x3.v
add_fileset_file mkGPR_RegFile.v VERILOG PATH ../Verilog_RTL/mkGPR_RegFile.v
add_fileset_file mkIntMul_32.v VERILOG PATH ../Verilog_RTL/mkIntMul_32.v
add_fileset_file mkIntMul_64.v VERILOG PATH ../Verilog_RTL/mkIntMul_64.v
add_fileset_file mkJtagTap.v VERILOG PATH ../Verilog_RTL/mkJtagTap.v
add_fileset_file mkMMU_Cache.v VERILOG PATH ../Verilog_RTL/mkMMU_Cache.v
add_fileset_file mkMMU_DCache.v VERILOG PATH ../Verilog_RTL/mkMMU_DCache.v
add_fileset_file mkMMU_ICache.v VERILOG PATH ../Verilog_RTL/mkMMU_ICache.v
add_fileset_file mkMem_Controller.v VERILOG PATH ../Verilog_RTL/mkMem_Controller.v
add_fileset_file mkMem_Model.v VERILOG PATH ../Verilog_RTL/mkMem_Model.v
add_fileset_file mkNear_Mem.v VERILOG PATH ../Verilog_RTL/mkNear_Mem.v
add_fileset_file mkNear_Mem_IO_AXI4.v VERILOG PATH ../Verilog_RTL/mkNear_Mem_IO_AXI4.v
add_fileset_file mkP2_Core.v VERILOG PATH ../Verilog_RTL/mkP2_Core.v TOP_LEVEL_FILE
add_fileset_file mkPLIC_16_2_7.v VERILOG PATH ../Verilog_RTL/mkPLIC_16_2_7.v
add_fileset_file mkRISCV_MBox.v VERILOG PATH ../Verilog_RTL/mkRISCV_MBox.v
add_fileset_file mkSoC_Map.v VERILOG PATH ../Verilog_RTL/mkSoC_Map.v
add_fileset_file mkTLB.v VERILOG PATH ../Verilog_RTL/mkTLB.v
add_fileset_file mkTV_Encode.v VERILOG PATH ../Verilog_RTL/mkTV_Encode.v
add_fileset_file mkTV_Xactor.v VERILOG PATH ../Verilog_RTL/mkTV_Xactor.v
add_fileset_file mkTagController.v VERILOG PATH ../Verilog_RTL/mkTagController.v
add_fileset_file mkUART.v VERILOG PATH ../Verilog_RTL/mkUART.v
