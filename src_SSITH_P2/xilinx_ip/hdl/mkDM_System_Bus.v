...
module mkDM_System_Bus(CLK,
  ...
  reg [63 : 0] CASE_rg_sbaddress_reading_BITS_2_TO_0_0x0_resu_ETC__q1,
	       ...
	       wrd_wdata__h4334;
  reg [7 : 0] wrd_wstrb__h4335;
  reg [2 : 0] x__h2591, x__h4239;
  wire [63 : 0] _theResult___fst__h4277,
		addr64__h3638,
		result__h1187,
		result__h1217,
		result__h1244,
  ...
  wire [31 : 0] IF_rg_sbcs_sbreadonaddr_24_THEN_IF_rg_sbcs_sba_ETC___d310,
		...
		v__h2069,
		v__h2203;
  wire [7 : 0] strobe64__h4276, strobe64__h4279, strobe64__h4282;
  wire [5 : 0] shift_bits__h4224;
  ...
  always@(av_read_dm_addr or
	  v__h2069 or rg_sbaddress0 or rg_sbaddress1 or v__h2203)
  begin
    case (av_read_dm_addr)
      7'h38: av_read = v__h2069;
      7'h39: av_read = rg_sbaddress0;
      7'h3A: av_read = rg_sbaddress1;
      7'h3C: av_read = v__h2203;
  ...
  assign MUX_master_xactor_f_rd_addr$enq_1__VAL_1 =
	     { 4'd0, sbaddress__h624, 8'd0, x__h2591, 18'd65536 } ;
  assign MUX_master_xactor_f_rd_addr$enq_1__VAL_2 =
	     { 4'd0, addr64__h3638, 8'd0, x__h2591, 18'd65536 } ;
  ...
  assign master_xactor_f_wr_addr$D_IN =
	     { 4'd0, sbaddress__h624, 8'd0, x__h4239, 18'd65536 } ;
  ...
  assign master_xactor_f_wr_data$D_IN =
	     { wrd_wdata__h4334, wrd_wstrb__h4335, 1'd1 } ;
  ...
  assign IF_write_dm_addr_EQ_0x39_58_THEN_rg_sbaddress1_ETC___d301 =
	     (write_dm_addr == 7'h39) ?
	       ...
	       write_dm_word ;
  assign _theResult___fst__h4277 = word64__h4221 << shift_bits__h4224 ;
  assign addr64__h3638 = { rg_sbaddress1, write_dm_word } ;
  assign result__h1187 = { 56'd0, master_xactor_f_rd_data$D_OUT[10:3] } ;
  assign result__h1217 = { 56'd0, master_xactor_f_rd_data$D_OUT[18:11] } ;
  assign result__h1244 = { 56'd0, master_xactor_f_rd_data$D_OUT[26:19] } ;
  assign result__h1271 = { 56'd0, master_xactor_f_rd_data$D_OUT[34:27] } ;
  assign result__h1298 = { 56'd0, master_xactor_f_rd_data$D_OUT[42:35] } ;
  assign result__h1325 = { 56'd0, master_xactor_f_rd_data$D_OUT[50:43] } ;
  assign result__h1352 = { 56'd0, master_xactor_f_rd_data$D_OUT[58:51] } ;
  assign result__h1379 = { 56'd0, master_xactor_f_rd_data$D_OUT[66:59] } ;
  assign result__h1424 = { 48'd0, master_xactor_f_rd_data$D_OUT[18:3] } ;
  assign result__h1451 = { 48'd0, master_xactor_f_rd_data$D_OUT[34:19] } ;
  assign result__h1478 = { 48'd0, master_xactor_f_rd_data$D_OUT[50:35] } ;
  assign result__h1505 = { 48'd0, master_xactor_f_rd_data$D_OUT[66:51] } ;
  assign result__h1546 = { 32'd0, master_xactor_f_rd_data$D_OUT[34:3] } ;
  assign result__h1573 = { 32'd0, master_xactor_f_rd_data$D_OUT[66:35] } ;
  ...
  assign rg_sbcs_sberror_EQ_0_AND_rg_sbcs_sbreadonaddr__ETC___d291 =
	     ...
	     (rg_sbcs_sbreadonaddr && rg_sbcs_sbautoincrement ||
	      write_dm_addr != 7'h39) ;
  assign sbaddress__h624 = { rg_sbaddress1, rg_sbaddress0 } ;
  assign shift_bits__h4224 = { rg_sbaddress0[2:0], 3'b0 } ;
  assign strobe64__h4276 = 8'b00000001 << rg_sbaddress0[2:0] ;
  assign strobe64__h4279 = 8'b00000011 << rg_sbaddress0[2:0] ;
  assign strobe64__h4282 = 8'b00001111 << rg_sbaddress0[2:0] ;
  assign v__h2069 =
	     { 9'd64,
	       rg_sbcs_sbbusyerror,
	       rg_sb_state != 2'd0,
  ...
  assign v__h2203 =
	     (rg_sb_state != 2'd0 || rg_sbcs_sbbusyerror ||
	      rg_sbcs_sberror != 3'd0) ?
	       32'd0 :
	       rg_sbdata0 ;
  assign word64__h4221 = { 32'd0, write_dm_word } ;
  ...
  begin
    case (rg_sbcs_sbaccess)
      3'd0, 3'd1, 3'd2: x__h2591 = rg_sbcs_sbaccess;
      default: x__h2591 = 3'b011;
    endcase
  end
  always@(rg_sbcs_sbaccess)
  begin
    case (rg_sbcs_sbaccess)
      3'd0, 3'd1, 3'd2, 3'd3: x__h4239 = rg_sbcs_sbaccess;
      default: x__h4239 = 3'b111;
    endcase
  end
  always@(rg_sbcs_sbaccess or
	  strobe64__h4276 or strobe64__h4279 or strobe64__h4282)
  begin
    case (rg_sbcs_sbaccess)
      3'd0: wrd_wstrb__h4335 = strobe64__h4276;
      3'd1: wrd_wstrb__h4335 = strobe64__h4279;
      3'd2: wrd_wstrb__h4335 = strobe64__h4282;
      3'd3: wrd_wstrb__h4335 = 8'b11111111;
      default: wrd_wstrb__h4335 = 8'd0;
    endcase
  end
  always@(rg_sbcs_sbaccess or word64__h4221 or _theResult___fst__h4277)
  begin
    case (rg_sbcs_sbaccess)
      3'd0, 3'd1, 3'd2: wrd_wdata__h4334 = _theResult___fst__h4277;
      default: wrd_wdata__h4334 = word64__h4221;
    endcase
  end
  always@(rg_sbaddress_reading or
	  ...
	  result__h1244 or
	  result__h1271 or
	  result__h1298 or result__h1325 or result__h1352 or result__h1379)
  begin
  ...
  always@(rg_sbaddress_reading or
	  result__h1424 or result__h1451 or result__h1478 or result__h1505)
  begin
    case (rg_sbaddress_reading[2:0])
      3'h0:
	  IF_rg_sbaddress_reading_0_BITS_2_TO_0_1_EQ_0x0_ETC___d66 =
  ...
  always@(rg_sbaddress_reading or result__h1546 or result__h1573)
  begin
    case (rg_sbaddress_reading[2:0])
      3'h0:
