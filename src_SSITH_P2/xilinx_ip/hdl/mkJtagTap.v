...
module mkJtagTap(CLK,
  ...
  reg [39 : 0] CASE_newir393_0_1_1_2147483648_0x12_1_0x13_1_0_ETC__q1,
	       v__h2093;
  reg [17 : 0] newir__h3393;
  ...
  wire [39 : 0] IF_r_dmistat_busy_port0__read__35_OR_NOT_r_dmi_ETC___d138,
		...
		x__h2616,
		y__h2617;
  wire [17 : 0] v__h3257, x__h3308, y__h3309;
  ...
  // register r_dr
  always@(r_state or r_dr or v__h2093 or v__h2559)
  begin
    case (r_state)
      4'd0: r_dr$D_IN = r_dr;
      4'd3: r_dr$D_IN = v__h2093;
      4'd4: r_dr$D_IN = v__h2559;
  ...
  assign r_drmask$D_IN =
	     (r_state == 4'd3) ?
	       CASE_newir393_0_1_1_2147483648_0x12_1_0x13_1_0_ETC__q1 :
	       r_drmask ;
  assign r_drmask$EN = 1'd1 ;

  // register r_ir
  assign r_ir$D_IN = newir__h3393 ;
  assign r_ir$EN = 1'd1 ;
  ...
  assign r_state_EQ_8_0_AND_r_ir_EQ_0b11100100100100_2__ETC___d70 =
	     ...
	     r_dmi[1:0] != 2'd3 &&
	     !f_dmi_busy$EMPTY_N ;
  assign v__h2191 = { 22'd960, r_ir } ;
  assign v__h2559 = x__h2616 | y__h2617 ;
  assign v__h3257 = x__h3308 | y__h3309 ;
  assign x__h2328 =
	     { 6'bxxxxxx /* unspecified value */ ,
	       32'bxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx /* unspecified value */ ,
	       2'd3 } ;
  assign x__h2407 = { 28'd0, r_dmi[1:0], 10'd97 } ;
  assign x__h2616 = { 1'd0, r_dr[39:1] } ;
  assign x__h3308 = { 1'd0, r_ir[17:1] } ;
  assign y__h2617 = jtag_tdi ? r_drmask : 40'd0 ;
  assign y__h3309 = jtag_tdi ? 18'd131072 : 18'd0 ;
  always@(r_state or r_ir or v__h3257)
  begin
    case (r_state)
      4'd0: newir__h3393 = 18'd1;
      4'd3, 4'd4, 4'd8: newir__h3393 = r_ir;
      4'd11: newir__h3393 = v__h3257;
      default: newir__h3393 = r_ir;
    endcase
  end
  always@(r_ir or
	  v__h2191 or
  ...
  begin
    case (r_ir)
      ...
      18'd262143:
	  v__h2093 = 40'd0;
      18'd1: v__h2093 = 40'd4093;
      18'b000011100100100100:
	  v__h2093 =
	      IF_r_dmistat_busy_port0__read__35_OR_NOT_r_dmi_ETC___d138;
      18'b100010100100100100: v__h2093 = x__h2407;
      default: v__h2093 = v__h2191;
    endcase
  end
  always@(newir__h3393)
  begin
    case (newir__h3393)
      ...
      18'h00017,
      18'd262143:
	  CASE_newir393_0_1_1_2147483648_0x12_1_0x13_1_0_ETC__q1 = 40'd1;
	  ...
	  CASE_newir393_0_1_1_2147483648_0x12_1_0x13_1_0_ETC__q1 =
	      40'h8000000000;
      default: CASE_newir393_0_1_1_2147483648_0x12_1_0x13_1_0_ETC__q1 =
		   40'h0100000000;
    endcase
  end
  always@(r_state)
