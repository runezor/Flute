...
module mkNear_Mem_IO_AXI4(CLK,
  ...
  reg [63 : 0] _theResult___fst__h2545;
  reg [1 : 0] _theResult___snd__h2546, v__h3487;
  wire [63 : 0] byte_addr__h2384,
		byte_addr__h3325,
  ...
  wire [1 : 0] rresp__h2527, v__h3329;
  ...
  assign MUX_crg_time$port1__write_1__SEL_1 =
	     WILL_FIRE_RL_rl_process_wr_req &&
	     !slave_xactor_f_wr_addr_first__00_BITS_92_TO_29_ETC___d102 &&
	     (byte_addr__h3325 == 64'h000000000000BFF8 ||
	      byte_addr__h3325 == 64'h000000000000BFFC) ;
  assign MUX_crg_timecmp$port1__write_1__SEL_1 =
	     WILL_FIRE_RL_rl_process_wr_req &&
	     !slave_xactor_f_wr_addr_first__00_BITS_92_TO_29_ETC___d102 &&
	     (byte_addr__h3325 == 64'h0000000000004000 ||
	      byte_addr__h3325 == 64'h0000000000004004) ;
  assign MUX_rg_msip$write_1__SEL_1 =
	     WILL_FIRE_RL_rl_process_wr_req &&
	     !slave_xactor_f_wr_addr_first__00_BITS_92_TO_29_ETC___d102 &&
	     byte_addr__h3325 == 64'h0 &&
	     !rg_msip_7_EQ_slave_xactor_f_wr_data_first__06__ETC___d108 ;
  ...
  assign crg_time$port1__write_1 =
	     MUX_crg_time$port1__write_1__SEL_1 ? new_time__h5026 : 64'd1 ;
  ...
  assign slave_xactor_f_wr_resp$D_IN =
	     { slave_xactor_f_wr_addr$D_OUT[96:93], v__h3329 } ;
  ...
  assign new_time__h5026 = x__h5068 | y__h3780 ;
  assign new_timecmp__h3737 = x__h3779 | y__h3780 ;
  assign old_time__h7584 =
	     CAN_FIRE_RL_rl_tick_timer ? crg_time$port0__write_1 : crg_time ;
  assign rdata___1__h2541 = { 63'd0, rg_msip } ;
  assign rg_msip_7_EQ_slave_xactor_f_wr_data_first__06__ETC___d108 =
	     rg_msip == slave_xactor_f_wr_data$D_OUT[9] ;
  assign rresp__h2527 =
	     slave_xactor_f_rd_addr_first__1_BITS_92_TO_29__ETC___d53 ?
	       2'b11 :
	       _theResult___snd__h2546 ;
  ...
  assign x__h2730 =
	     slave_xactor_f_rd_addr_first__1_BITS_92_TO_29__ETC___d53 ?
	       64'd0 :
	       _theResult___fst__h2545 ;
  assign x__h3779 = crg_timecmp & y__h3781 ;
  assign x__h5068 = old_time__h7584 & y__h3781 ;
  assign y__h3780 = slave_xactor_f_wr_data$D_OUT[72:9] & mask__h3768 ;
  assign y__h3781 =
	     { ~SEXT_slave_xactor_f_wr_data_first__06_BIT_8_51___d152,
	       ~SEXT_slave_xactor_f_wr_data_first__06_BIT_7_54___d155,
	       ~SEXT_slave_xactor_f_wr_data_first__06_BIT_6_58___d159,
	       ...
	       ~SEXT_slave_xactor_f_wr_data_first__06_BIT_2_72___d173,
	       ~SEXT_slave_xactor_f_wr_data_first__06_BIT_1_75___d176 } ;
  always@(byte_addr__h2384)
  begin
    case (byte_addr__h2384)
      64'h0,
	  ...
	  _theResult___snd__h2546 = 2'b0;
      default: _theResult___snd__h2546 = 2'b11;
    endcase
  end
  always@(byte_addr__h2384 or rdata___1__h2541 or crg_timecmp or crg_time)
  begin
    case (byte_addr__h2384)
      64'h0: _theResult___fst__h2545 = rdata___1__h2541;
      64'h0000000000000004: _theResult___fst__h2545 = 64'd0;
      64'h0000000000004000, 64'h0000000000004004:
	  _theResult___fst__h2545 = crg_timecmp;
      64'h000000000000BFF8, 64'h000000000000BFFC:
	  _theResult___fst__h2545 = crg_time;
      default: _theResult___fst__h2545 = 64'd0;
    endcase
  end
  always@(byte_addr__h3325)
  begin
    case (byte_addr__h3325)
      64'h0,
      64'h0000000000000004,
      64'h0000000000004000,
      64'h0000000000004004,
  ...
  begin
    ...
    v__h1825 = v__h1831 / 32'd10;
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_reset && cfg_verbosity != 4'd0)
	$display("%0d: Near_Mem_IO_AXI4.rl_reset", v__h1825);
    if (RST_N != `BSV_RESET_VALUE)
    ...
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_process_rd_req &&
	  (slave_xactor_f_rd_addr_first__1_BITS_92_TO_29__ETC___d53 ||
	   byte_addr__h2384 != 64'h0 &&
	   byte_addr__h2384 != 64'h0000000000004000 &&
	   byte_addr__h2384 != 64'h000000000000BFF8 &&
	   byte_addr__h2384 != 64'h0000000000000004 &&
	   byte_addr__h2384 != 64'h0000000000004004 &&
	   byte_addr__h2384 != 64'h000000000000BFFC))
	begin
	  v__h2619 = $stime;
	  #0;
	end
    v__h2613 = v__h2619 / 32'd10;
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_process_rd_req &&
	  (slave_xactor_f_rd_addr_first__1_BITS_92_TO_29__ETC___d53 ||
	   byte_addr__h2384 != 64'h0 &&
    ...
    v__h2851 = v__h2857 / 32'd10;
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_process_rd_req &&
	  NOT_cfg_verbosity_read_ULE_1_0___d31)
	$display("%0d: Near_Mem_IO_AXI4.rl_process_rd_req", v__h2851);
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_process_rd_req &&
	  NOT_cfg_verbosity_read_ULE_1_0___d31)
	$write("            ");
    ...
    if (RST_N != `BSV_RESET_VALUE)
	  ...
	  byte_addr__h3325 == 64'h0000000000004000 &&
	  NOT_cfg_verbosity_read_ULE_1_0___d31)
	$display("        new MTIMECMP         = 0x%0h", new_timecmp__h3737);
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_process_wr_req &&
	  !slave_xactor_f_wr_addr_first__00_BITS_92_TO_29_ETC___d102 &&
	  byte_addr__h3325 == 64'h0000000000004000 &&
	  NOT_cfg_verbosity_read_ULE_1_0___d31)
	$display("        cur MTIME            = 0x%0h", old_time__h7584);
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_process_wr_req &&
	  !slave_xactor_f_wr_addr_first__00_BITS_92_TO_29_ETC___d102 &&
	  byte_addr__h3325 == 64'h0000000000004000 &&
    ...
    if (RST_N != `BSV_RESET_VALUE)
	  ...
	  byte_addr__h3325 == 64'h000000000000BFF8 &&
	  NOT_cfg_verbosity_read_ULE_1_0___d31)
	$display("        old MTIME = 0x%0h", old_time__h7584);
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_process_wr_req &&
	  !slave_xactor_f_wr_addr_first__00_BITS_92_TO_29_ETC___d102 &&
	  byte_addr__h3325 == 64'h000000000000BFF8 &&
	  NOT_cfg_verbosity_read_ULE_1_0___d31)
	$display("        new MTIME = 0x%0h", new_time__h5026);
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_process_wr_req &&
	  !slave_xactor_f_wr_addr_first__00_BITS_92_TO_29_ETC___d102 &&
	  byte_addr__h3325 == 64'h0000000000004004 &&
    ...
    if (RST_N != `BSV_RESET_VALUE)
	  ...
	  (slave_xactor_f_wr_addr_first__00_BITS_92_TO_29_ETC___d102 ||
	   ...
	   byte_addr__h3325 != 64'h0000000000004000 &&
	   byte_addr__h3325 != 64'h000000000000BFF8 &&
	   byte_addr__h3325 != 64'h0000000000000004 &&
	   byte_addr__h3325 != 64'h0000000000004004 &&
	   byte_addr__h3325 != 64'h000000000000BFFC))
	begin
	  v__h8897 = $stime;
    ...
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_process_wr_req &&
	  NOT_cfg_verbosity_read_ULE_1_0___d31)
	$display("%0d: Near_Mem_IO.AXI4.rl_process_wr_req", v__h9110);
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_process_wr_req &&
	  NOT_cfg_verbosity_read_ULE_1_0___d31)
	$write("            ");
