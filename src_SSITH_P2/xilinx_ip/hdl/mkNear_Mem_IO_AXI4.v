...
module mkNear_Mem_IO_AXI4(CLK,
  ...
  reg [63 : 0] _theResult___fst__h2616;
  reg [1 : 0] CASE_byte_addr423_0x0_0_0x4_0_0x4000_0_0x4004__ETC__q2,
	      CASE_byte_addr515_0x0_0_0x4_0_0x4000_0_0x4004__ETC__q1;
  wire [63 : 0] byte_addr__h2423,
		byte_addr__h3515,
  ...
  assign MUX_crg_time$port1__write_1__SEL_1 =
	     WILL_FIRE_RL_rl_process_wr_req &&
	     !slavePortShim_awff_first__36_BITS_92_TO_29_37__ETC___d138 &&
	     (byte_addr__h3515 == 64'h000000000000BFF8 ||
	      byte_addr__h3515 == 64'h000000000000BFFC) ;
  assign MUX_crg_timecmp$port1__write_1__SEL_1 =
	     WILL_FIRE_RL_rl_process_wr_req &&
	     !slavePortShim_awff_first__36_BITS_92_TO_29_37__ETC___d138 &&
	     (byte_addr__h3515 == 64'h0000000000004000 ||
	      byte_addr__h3515 == 64'h0000000000004004) ;
  assign MUX_rg_msip$write_1__SEL_1 =
	     WILL_FIRE_RL_rl_process_wr_req &&
	     !slavePortShim_awff_first__36_BITS_92_TO_29_37__ETC___d138 &&
	     byte_addr__h3515 == 64'h0 &&
	     !rg_msip_07_EQ_slavePortShim_wff_first__42_BIT__ETC___d144 ;
  ...
  assign crg_time$port1__write_1 =
	     MUX_crg_time$port1__write_1__SEL_1 ? new_time__h5246 : 64'd1 ;
  ...
  assign slavePortShim_rff$D_IN =
	     { slavePortShim_arff$D_OUT[97:93],
	       ...
	       slavePortShim_arff_first__4_BITS_92_TO_29_6_UL_ETC___d71 ?
		 2'd3 :
		 CASE_byte_addr423_0x0_0_0x4_0_0x4000_0_0x4004__ETC__q2,
	       1'd1 } ;
  ...
  assign byte_addr__h2423 = slavePortShim_arff$D_OUT[92:29] - rg_addr_base ;
  assign byte_addr__h3515 = slavePortShim_awff$D_OUT[92:29] - rg_addr_base ;
  assign crg_timecmp_port1__read__09_AND_INV_SEXT_slave_ETC___d248 =
	     new_timecmp__h3957 - old_time__h7805 ;
  assign mask__h3988 =
	     { SEXT_slavePortShim_wff_first__42_BIT_8_10___d211,
	       SEXT_slavePortShim_wff_first__42_BIT_7_13___d214,
	       SEXT_slavePortShim_wff_first__42_BIT_6_17___d218,
  ...
  assign new_time__h5246 = x__h5288 | y__h4000 ;
  assign new_timecmp__h3957 = x__h3999 | y__h4000 ;
  assign old_time__h7805 =
	     CAN_FIRE_RL_rl_tick_timer ? crg_time$port0__write_1 : crg_time ;
  assign rdata___1__h2612 = { 63'd0, rg_msip } ;
  ...
  assign slavePortShim_arff_first__4_BITS_92_TO_29_6_UL_ETC___d104 =
	     (slavePortShim_arff_first__4_BITS_92_TO_29_6_UL_ETC___d71 ||
	      byte_addr__h2423 != 64'h0 &&
	      byte_addr__h2423 != 64'h0000000000004000 &&
	      byte_addr__h2423 != 64'h000000000000BFF8 &&
	      byte_addr__h2423 != 64'h0000000000000004 &&
	      byte_addr__h2423 != 64'h0000000000004004 &&
	      byte_addr__h2423 != 64'h000000000000BFFC) &&
  ...
  assign slavePortShim_awff_first__36_BITS_92_TO_29_37__ETC___d280 =
	     (slavePortShim_awff_first__36_BITS_92_TO_29_37__ETC___d138 ||
	      ...
	      byte_addr__h3515 != 64'h0000000000004000 &&
	      byte_addr__h3515 != 64'h000000000000BFF8 &&
	      byte_addr__h3515 != 64'h0000000000000004 &&
	      byte_addr__h3515 != 64'h0000000000004004 &&
	      byte_addr__h3515 != 64'h000000000000BFFC) &&
  ...
  assign x__h2834 =
	     slavePortShim_arff_first__4_BITS_92_TO_29_6_UL_ETC___d71 ?
	       64'd0 :
	       _theResult___fst__h2616 ;
  assign x__h3999 = crg_timecmp & y__h4001 ;
  assign x__h5288 = old_time__h7805 & y__h4001 ;
  assign y__h4000 = slavePortShim_wff$D_OUT[72:9] & mask__h3988 ;
  assign y__h4001 =
	     { ~SEXT_slavePortShim_wff_first__42_BIT_8_10___d211,
	       ~SEXT_slavePortShim_wff_first__42_BIT_7_13___d214,
	       ~SEXT_slavePortShim_wff_first__42_BIT_6_17___d218,
	       ...
	       ~SEXT_slavePortShim_wff_first__42_BIT_2_31___d232,
	       ~SEXT_slavePortShim_wff_first__42_BIT_1_34___d235 } ;
  always@(byte_addr__h2423 or rdata___1__h2612 or crg_timecmp or crg_time)
  begin
    case (byte_addr__h2423)
      64'h0: _theResult___fst__h2616 = rdata___1__h2612;
      64'h0000000000000004: _theResult___fst__h2616 = 64'd0;
      64'h0000000000004000, 64'h0000000000004004:
	  _theResult___fst__h2616 = crg_timecmp;
      64'h000000000000BFF8, 64'h000000000000BFFC:
	  _theResult___fst__h2616 = crg_time;
      default: _theResult___fst__h2616 = 64'd0;
    endcase
  end
  always@(byte_addr__h3515)
  begin
    case (byte_addr__h3515)
      64'h0,
	  ...
	  CASE_byte_addr515_0x0_0_0x4_0_0x4000_0_0x4004__ETC__q1 = 2'd0;
      default: CASE_byte_addr515_0x0_0_0x4_0_0x4000_0_0x4004__ETC__q1 = 2'd3;
    endcase
  end
  always@(byte_addr__h2423)
  begin
    case (byte_addr__h2423)
      64'h0,
      64'h0000000000000004,
      ...
      64'h000000000000BFF8,
      64'h000000000000BFFC:
	  CASE_byte_addr423_0x0_0_0x4_0_0x4000_0_0x4004__ETC__q2 = 2'd0;
      default: CASE_byte_addr423_0x0_0_0x4_0_0x4000_0_0x4004__ETC__q2 = 2'd3;
    endcase
  end
  ...
  begin
    ...
    v__h2955 = v__h2961 / 32'd10;
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_process_rd_req &&
	  NOT_cfg_verbosity_read_ULE_1_1___d32)
	$display("%0d: Near_Mem_IO_AXI4.rl_process_rd_req", v__h2955);
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_process_rd_req &&
	  NOT_cfg_verbosity_read_ULE_1_1___d32)
	$write("            ");
    ...
    if (RST_N != `BSV_RESET_VALUE)
	  ...
	  byte_addr__h3515 == 64'h0000000000004000 &&
	  NOT_cfg_verbosity_read_ULE_1_1___d32)
	$display("        new MTIMECMP         = 0x%0h", new_timecmp__h3957);
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_process_wr_req &&
	  !slavePortShim_awff_first__36_BITS_92_TO_29_37__ETC___d138 &&
	  byte_addr__h3515 == 64'h0000000000004000 &&
	  NOT_cfg_verbosity_read_ULE_1_1___d32)
	$display("        cur MTIME            = 0x%0h", old_time__h7805);
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_process_wr_req &&
	  !slavePortShim_awff_first__36_BITS_92_TO_29_37__ETC___d138 &&
	  byte_addr__h3515 == 64'h0000000000004000 &&
    ...
    if (RST_N != `BSV_RESET_VALUE)
	  ...
	  byte_addr__h3515 == 64'h000000000000BFF8 &&
	  NOT_cfg_verbosity_read_ULE_1_1___d32)
	$display("        old MTIME = 0x%0h", old_time__h7805);
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_process_wr_req &&
	  !slavePortShim_awff_first__36_BITS_92_TO_29_37__ETC___d138 &&
	  byte_addr__h3515 == 64'h000000000000BFF8 &&
	  NOT_cfg_verbosity_read_ULE_1_1___d32)
	$display("        new MTIME = 0x%0h", new_time__h5246);
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_process_wr_req &&
	  !slavePortShim_awff_first__36_BITS_92_TO_29_37__ETC___d138 &&
	  byte_addr__h3515 == 64'h0000000000004004 &&
    ...
    v__h9364 = v__h9370 / 32'd10;
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_process_wr_req &&
	  NOT_cfg_verbosity_read_ULE_1_1___d32)
	$display("%0d: Near_Mem_IO.AXI4.rl_process_wr_req", v__h9364);
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_process_wr_req &&
	  NOT_cfg_verbosity_read_ULE_1_1___d32)
	$write("            ");
    ...
    v__h1816 = v__h1822 / 32'd10;
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_reset && cfg_verbosity != 4'd0)
	$display("%0d: Near_Mem_IO_AXI4.rl_reset", v__h1816);
  end
  // synopsys translate_on
