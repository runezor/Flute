...
module mkIntMul_64(CLK,
  ...
  wire [127 : 0] x__h274, x__h367, xy___1__h291;
  wire [63 : 0] _theResult___fst__h528,
  ...
  // inputs to muxes for submodule ports
  assign MUX_m_rg_x$write_1__VAL_1 = { 64'd0, _theResult___fst__h528 } ;
  assign MUX_m_rg_x$write_1__VAL_2 = { m_rg_x[126:0], 1'd0 } ;
  assign MUX_m_rg_xy$write_1__VAL_2 = (m_rg_y == 64'd0) ? x__h274 : x__h367 ;
  ...
  assign _theResult___fst__h531 = put_args_x[63] ? -put_args_x : put_args_x ;
  assign _theResult___fst__h573 =
	     put_args_y_is_signed ? _theResult___fst__h576 : put_args_y ;
  assign _theResult___fst__h576 = put_args_y[63] ? -put_args_y : put_args_y ;
