...
module mkCore(CLK,
  ...
  begin
    ...
    v__h5056 = v__h5062 / 32'd10;
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_cpu_hart0_reset_from_soc_start)
	$display("%0d: Core.rl_cpu_hart0_reset_from_soc_start", v__h5056);
    if (RST_N != `BSV_RESET_VALUE)
    ...
    v__h5257 = v__h5263 / 32'd10;
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_cpu_hart0_reset_from_dm_start)
	$display("%0d: Core.rl_cpu_hart0_reset_from_dm_start", v__h5257);
    if (RST_N != `BSV_RESET_VALUE)
    ...
    v__h5625 = v__h5631 / 32'd10;
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_cpu_hart0_reset_complete)
	$display("%0d: Core.rl_cpu_hart0_reset_complete", v__h5625);
  end
  // synopsys translate_on
endmodule  // mkCore
