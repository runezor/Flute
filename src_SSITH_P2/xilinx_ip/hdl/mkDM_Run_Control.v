...
module mkDM_Run_Control(CLK,
  ...
  always@(av_read_dm_addr or
	  rg_verbosity or
	  virt_rg_dmcontrol__h888 or virt_rg_dmstatus__h784 or haltsum__h692)
  begin
    case (av_read_dm_addr)
      7'h10: av_read = virt_rg_dmcontrol__h888;
  ...
  assign virt_rg_dmcontrol__h888 =
	     { 2'b0,
  ...
  begin
    ...
    if (RST_N != `BSV_RESET_VALUE)
      if (EN_write && write_dm_addr == 7'h10 && write_dm_word[0] &&
	  NOT_rg_dmstatus_allunavail_9_5_AND_rg_dmcontro_ETC___d111)
	$display("%0d: %m.dmcontrol_write: hart0 resume request", v__h3012);
    if (RST_N != `BSV_RESET_VALUE)
      if (EN_write && write_dm_addr == 7'h10 && write_dm_word[0] &&
	  NOT_rg_dmstatus_allunavail_9_5_AND_rg_dmcontro_ETC___d120)
	begin
    ...
    v__h3052 = v__h3058 / 32'd10;
    if (RST_N != `BSV_RESET_VALUE)
      if (EN_write && write_dm_addr == 7'h10 && write_dm_word[0] &&
	  NOT_rg_dmstatus_allunavail_9_5_AND_rg_dmcontro_ETC___d120)
	$display("%0d: %m.dmcontrol_write: hart0 halt request", v__h3052);
    if (RST_N != `BSV_RESET_VALUE)
      if (EN_write && write_dm_addr == 7'h10 && !write_dm_word[0])
	begin
	  v__h2095 = $stime;
