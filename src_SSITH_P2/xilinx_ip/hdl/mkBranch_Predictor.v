...
module mkBranch_Predictor(CLK,
  ...
  reg [63 : 0] _theResult_____1_fst__h8906;
  reg [1 : 0] _theResult_____1_snd__h8865, _theResult_____1_snd__h8907;
  wire [63 : 0] IF_IF_bp_train_is_i32_not_i16_THEN_NOT_bp_trai_ETC___d256,
		...
		_theResult_____1_fst__h8750,
		_theResult_____1_fst__h8864,
		pred_pc___1__h3683,
		pred_pc__h2569,
		ret_pc___1__h4436,
		ret_pc__h4397;
  wire [1 : 0] _theResult_____1_snd_snd__h8752;
  ...
  always@(bp_train_cf_info or
	  rf_btb_fsms$D_OUT_1 or _theResult_____1_snd_snd__h8752)
  begin
    case (bp_train_cf_info[194:193])
      2'd0: MUX_rf_btb_fsms$upd_2__VAL_1 = _theResult_____1_snd_snd__h8752;
  ...
  assign IF_IF_bp_train_is_i32_not_i16_THEN_bp_train_in_ETC___d428 =
	     (IF_bp_train_is_i32_not_i16_THEN_bp_train_instr_ETC___d158 ||
	      IF_bp_train_is_i32_not_i16_THEN_bp_train_instr_ETC___d199) ?
	       (bp_train_is_i32_not_i16 ? ret_pc__h4397 : ret_pc___1__h4436) :
	       IF_IF_bp_train_is_i32_not_i16_THEN_NOT_bp_trai_ETC___d407 ;
  ...
  assign _theResult_____1_fst__h8750 =
	     bp_train_cf_info[128] ?
	       _theResult_____1_fst__h8864 :
	       _theResult_____1_fst__h8906 ;
  assign _theResult_____1_fst__h8864 =
	     (rf_btb_fsms$D_OUT_1 == 2'b0) ?
	       bp_train_cf_info[127:64] :
	       bp_train_cf_info[63:0] ;
  assign _theResult_____1_snd_snd__h8752 =
	     bp_train_cf_info[128] ?
	       _theResult_____1_snd__h8865 :
	       _theResult_____1_snd__h8907 ;
  ...
  assign bp_train_instr_BITS_6_TO_0_15_EQ_0b1100111_59__ETC___d170 =
	     ...
	     bp_train_instr[31:25] == 7'h7F &&
	     bp_train_instr[24:20] == 5'h0C ;
  assign pred_pc___1__h3683 = { btb_bramcore2$DOA[62:0], 1'b0 } ;
  assign pred_pc__h2569 =
  ...
  assign ret_pc___1__h4436 = bp_train_pc + 64'd2 ;
  assign ret_pc__h4397 = bp_train_pc + 64'd4 ;
  always@(rf_btb_fsms$D_OUT_1 or bp_train_cf_info)
  begin
    case (rf_btb_fsms$D_OUT_1)
      2'b0, 2'b01, 2'b10:
	  _theResult_____1_fst__h8906 = bp_train_cf_info[127:64];
      2'd3: _theResult_____1_fst__h8906 = bp_train_cf_info[63:0];
    endcase
  end
  always@(rf_btb_fsms$D_OUT_1)
  begin
    case (rf_btb_fsms$D_OUT_1)
      2'b0: _theResult_____1_snd__h8865 = 2'b01;
      2'b01: _theResult_____1_snd__h8865 = 2'b10;
      2'b10, 2'b11: _theResult_____1_snd__h8865 = 2'b11;
    endcase
  end
  always@(rf_btb_fsms$D_OUT_1)
  begin
    case (rf_btb_fsms$D_OUT_1)
      2'b0, 2'b01: _theResult_____1_snd__h8907 = 2'b0;
      2'b10: _theResult_____1_snd__h8907 = 2'b01;
      2'b11: _theResult_____1_snd__h8907 = 2'b10;
    endcase
  end
