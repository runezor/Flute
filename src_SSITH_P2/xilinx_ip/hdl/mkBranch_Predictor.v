...
module mkBranch_Predictor(CLK,
  ...
  reg [63 : 0] _theResult_____1_fst__h7492,
	       _theResult_____1_fst__h7536,
	       pred_PC__h7397;
  reg [1 : 0] _theResult_____1_snd__h7493, _theResult_____1_snd__h7537;
  ...
  wire [63 : 0] _theResult_____1__h2379,
		_theResult_____1_fst__h7425,
		_theResult____h2378,
		pred_pc__h3334,
		pred_pc__h3336,
		ret_pc___1__h4087,
		ret_pc__h4049;
  wire [1 : 0] _theResult_____1_snd__h7426;
  ...
  // value method predict_rsp
  assign predict_rsp =
	     (_theResult_____1__h2379 == 64'hFFFFFFFFFFFFFFFF) ?
	       pred_pc__h3336 :
	       _theResult_____1__h2379 ;
  ...
  assign MUX_btb_bramcore2$b_put_1__SEL_1 =
	     EN_bp_train && pred_PC__h7397 != 64'hFFFFFFFFFFFFFFFF ;
  assign MUX_btb_bramcore2$b_put_3__VAL_1 =
	     { 1'd1, bp_train_cf_info[192:139], pred_PC__h7397[63:1] } ;
  always@(bp_train_cf_info or
	  rf_btb_fsms$D_OUT_1 or _theResult_____1_snd__h7426)
  begin
    case (bp_train_cf_info[194:193])
      2'd0: MUX_rf_btb_fsms$upd_2__VAL_1 = _theResult_____1_snd__h7426;
  ...
  assign IF_IF_bp_train_is_i32_not_i16_THEN_NOT_bp_trai_ETC___d208 =
	     { IF_IF_bp_train_is_i32_not_i16_THEN_NOT_bp_trai_ETC___d204,
	       bp_train_is_i32_not_i16 ? ret_pc__h4049 : ret_pc___1__h4087 } ;
  ...
  assign _theResult_____1__h2379 =
	     (_theResult____h2378 == 64'hFFFFFFFFFFFFFFFF &&
	      btb_bramcore2$DOA[117] &&
	      btb_bramcore2$DOA[116:63] == rg_pc[63:10]) ?
	       pred_pc__h3334 :
	       _theResult____h2378 ;
  assign _theResult_____1_fst__h7425 =
	     bp_train_cf_info[128] ?
	       _theResult_____1_fst__h7492 :
	       _theResult_____1_fst__h7536 ;
  assign _theResult_____1_snd__h7426 =
	     bp_train_cf_info[128] ?
	       _theResult_____1_snd__h7493 :
	       _theResult_____1_snd__h7537 ;
  assign _theResult____h2378 =
	     (IF_predict_rsp_is_i32_not_i16_THEN_NOT_predict_ETC___d51 &&
	      IF_predict_rsp_is_i32_not_i16_THEN_predict_rsp_ETC___d86) ?
	       rg_ras[63:0] :
  ...
  assign bp_train_instr_BITS_15_TO_12_13_EQ_0b1001_26_A_ETC___d144 =
	     ...
	     bp_train_instr[6:2] == 5'd0 &&
	     bp_train_instr[1:0] == 2'b10 ;
  assign pred_pc__h3334 = { btb_bramcore2$DOA[62:0], 1'b0 } ;
  assign pred_pc__h3336 =
  ...
  assign predict_rsp_instr_BITS_15_TO_12_6_EQ_0b1001_7__ETC___d30 =
	     ...
	     predict_rsp_instr[6:2] == 5'd0 &&
	     predict_rsp_instr[1:0] == 2'b10 ;
  assign ret_pc___1__h4087 = bp_train_pc + 64'd2 ;
  assign ret_pc__h4049 = bp_train_pc + 64'd4 ;
  always@(rf_btb_fsms$D_OUT_1 or bp_train_cf_info)
  begin
    case (rf_btb_fsms$D_OUT_1)
      2'b0: _theResult_____1_fst__h7492 = bp_train_cf_info[127:64];
      2'b01, 2'b10, 2'b11:
	  _theResult_____1_fst__h7492 = bp_train_cf_info[63:0];
    endcase
  end
  always@(rf_btb_fsms$D_OUT_1 or bp_train_cf_info)
  begin
    case (rf_btb_fsms$D_OUT_1)
      2'b0, 2'b01, 2'b10:
	  _theResult_____1_fst__h7536 = bp_train_cf_info[127:64];
      2'b11: _theResult_____1_fst__h7536 = bp_train_cf_info[63:0];
    endcase
  end
  always@(bp_train_cf_info or _theResult_____1_fst__h7425)
  begin
    case (bp_train_cf_info[194:193])
      2'd0: pred_PC__h7397 = _theResult_____1_fst__h7425;
      2'd1, 2'd2: pred_PC__h7397 = bp_train_cf_info[63:0];
      2'd3: pred_PC__h7397 = 64'hFFFFFFFFFFFFFFFF;
    endcase
  end
  always@(rf_btb_fsms$D_OUT_1)
  begin
    case (rf_btb_fsms$D_OUT_1)
      2'b0: _theResult_____1_snd__h7493 = 2'b01;
      2'b01: _theResult_____1_snd__h7493 = 2'b10;
      2'b10, 2'b11: _theResult_____1_snd__h7493 = 2'b11;
    endcase
  end
  always@(rf_btb_fsms$D_OUT_1)
  begin
    case (rf_btb_fsms$D_OUT_1)
      2'b0, 2'b01: _theResult_____1_snd__h7537 = 2'b0;
      2'b10: _theResult_____1_snd__h7537 = 2'b01;
      2'b11: _theResult_____1_snd__h7537 = 2'b10;
    endcase
  end
